...
const About = () => {
  ...
  // CTA button styles are changed to a more professional, darker blue/indigo.
  // Section padding has been adjusted for better flow on mobile.
  ...
  return (
    <div className={darkModeClass}>
      <div className="bg-white dark:bg-gray-900 transition-colors duration-500 min-h-screen"> 
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            >
              About Promed Health <span className="text-blue-500">Plus</span> 
            </motion.h1>
            <motion.p 
        ...
        <main className="container mx-auto px-4 sm:px-6 py-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <motion.div className="md:w-1/2" variants={itemVariants}>
                ...
                <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg">
                  At **ProMed Health Plus**, we are dedicated to transforming wound
                  care by equipping private practices with the tools and support
                  they need to thrive. With over 80% of our services dedicated
                  to empowering independent providers, we guide you from initial
                  setup through seamless reimbursement—with expert support at
                  every step. Our streamlined processes, selective partnerships,
                  and unwavering commitment to excellence ensure superior
                ...
                {about_approach_data.map((item, index) => (
                  ...
                  >
                    <div className="text-indigo-600 dark:text-indigo-400 mb-4">
                      ...
                      <i className={`fas fa-${index === 0 ? 'lightbulb' : index === 1 ? 'shield-alt' : 'project-diagram'} text-4xl`}></i>
                    </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             {about_team.map((member, index) => (
                <motion.div 
                  key={member.id}
                  className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-xl overflow-hidden transition-colors duration-300 group"
                  variants={itemVariants}
                >
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-90">
              Partner with ProMed Health Plus for unparalleled wound care support and reimbursement success.
            </p>
            <motion.button
      ...
      {/* No Framer Motion on the Modal itself, as it's handled by MUI, but updated for dark mode consistency. */}
      <Modal open={open} onClose={() => setOpen(false)}>
        <Box sx={modalStyle}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl dark:shadow-none p-8 mx-4 border border-gray-100 dark:border-gray-700 relative transition-colors duration-300">
            {/* ... Modal content remains the same (just ensuring all Tailwind classes are dark-mode compatible) ... */}
            {/* Close button */}
            <button
