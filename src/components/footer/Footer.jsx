      ...
      <footer className="bg-white text-center text-gray-800 ">
        <div className="flex items-center justify-center border-b-2 border-gray-200 p-6 lg:justify-between">
          <div className="mr-12 hidden lg:block">
            <span> <strong>Connected on social media:</strong></span>
          </div>
          {/* <!-- Social network icons container --> */}
          <div className="flex justify-center">
            <a className="mr-6 text-gray-800 hover:text-emerald-500 hover:text-emerald-500" href="#">
              <svg
            ...
            <a className="mr-6 text-gray-800 hover:text-emerald-500" href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="">
              ...
              <p className="mb-4">
                <a className="text-gray-800">React</a>
              </p>
              <p className="mb-4">
                <a className="text-gray-800">Vue</a>
              </p>
              <p>
                <a className="text-gray-800">
                  Laravel
